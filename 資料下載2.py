...
Data_Time_Start = '2023-01-01' # 應後續特徵處理時避免缺值，必須再提前目標一年
Data_Time_End = (datetime.today() - 
                 timedelta(days = 1)).strftime('%Y-%m-%d') # 使用昨天的日期作為結束日期
DataFolder = 'Ori_Data/'
...
excel_filename = f'USDto{Currency_symbol[:3]}_Currency_Data_Latest.xlsx' # 將匯率資料存儲為 Excel 檔案，以匯率代號作為檔案名稱
...
excel_filename = 'Dx-y_Data_Latest.xlsx'
...
excel_filename = 'Gold_Data_Latest.xlsx'
...
excel_filename = 'Fed_Funds_Rate_Latest.xlsx'
...
excel_filename = 'USA_CPI_Data_Latest.xlsx'
...
excel_filename = 'USA_Unemployment_Rate_Latest.xlsx'
...
excel_filename = 'USA_GDP_Latest.xlsx'
...
excel_filename = 'TW_CPI_Latest.xlsx'
...
# 儲存原始數據
excel_filename = 'TW_Base_Rate_Latest.xlsx'
...
excel_filename = 'TW_Rate_Latest.xlsx'
TW_rate.to_excel(DataFolder + excel_filename)
